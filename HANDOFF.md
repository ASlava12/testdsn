...
- `REPOSITORY_STAGE` is `milestone-18-real-pilot`.
...
- Milestone 18 real pilot is the current stage with
  `docs/PILOT_RUNBOOK.md`, `docs/PILOT_REPORT_TEMPLATE.md`, `devnet/pilot/`,
  `devnet/run-pilot-checklist.sh`, and documented pilot fault scenarios plus
  reporting.

## Recommended first Codex task

Use `prompts/codex-milestone-18.md` as the first task prompt for the current
`milestone-18-real-pilot` stage. It assumes the repository already has a
...
1. Confirm from `README.md`, `AGENTS.md`, and `IMPLEMENT.md` that the current
   stage is `milestone-18-real-pilot`.
